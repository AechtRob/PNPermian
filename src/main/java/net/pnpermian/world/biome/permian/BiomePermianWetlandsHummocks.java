...
public class BiomePermianWetlandsHummocks extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_wetlands_hummocks")
	public static final BiomeGenCustom biome = null;
	public BiomePermianWetlandsHummocks(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
...
//    	protected static final WorldGenTreeLog WALCHIA_LOG_GENERATOR = new WorldGenTreeLog(BlockWalchiaLog.block);
		...
		protected static final WorldGenSandyDirt DIRT_GENERATOR = new WorldGenSandyDirt();
...
//	        }
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 28; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockVojnovskyales.block.getDefaultState(), worldIn, rand, ChunkGenSpawner.getTopSolidBlock(pos.add(j, l, k), worldIn).up(), 68, 255);
				}

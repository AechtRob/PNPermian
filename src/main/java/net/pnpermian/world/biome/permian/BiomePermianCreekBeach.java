...
public class BiomePermianCreekBeach extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_creek_coastal")
	public static final BiomeGenCustom biome = null;
	public BiomePermianCreekBeach(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Coastal Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setWaterColor(13038245));
			setRegistryName("lepidodendron:permian_creek_coastal");
...
//				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 10; ++ii)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					STATIC_GENERATOR.generate(BlockCrinoidCalceolispongia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 30, 35, 255);
				}

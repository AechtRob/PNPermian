...
public class BiomePermianWetlandsFernCopse extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Highland Cirque").setRainfall(0.5F).setBaseHeight(0.025F).setHeightVariation(0.15F).setTemperature(0.95F).setRainfall(0.9F).setWaterColor(3906905));

...
public class BiomePermianStonyPlainsSpikes extends ElementsLepidodendronMod.ModElement {
	...
	public BiomePermianStonyPlainsSpikes(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Stony Plains").setRainfall(0.0F).setBaseHeight(3.5F).setHeightVariation(0.02F).setTemperature(2.0F).setRainDisabled());

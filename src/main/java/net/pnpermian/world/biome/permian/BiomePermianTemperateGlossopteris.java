...
public class BiomePermianTemperateGlossopteris extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_temperate_glossopteris")
	public static final BiomeGenCustom biome = null;
	public BiomePermianTemperateGlossopteris(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}

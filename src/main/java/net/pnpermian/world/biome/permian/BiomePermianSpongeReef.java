...
public class BiomePermianSpongeReef extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_ocean_sponge_reef")
	public static final BiomeGenCustom biome = null;
	public BiomePermianSpongeReef(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Sponge Reef").setBaseHeight(-1.05F).setHeightVariation(0.16F).setWaterColor(13038245));
			setRegistryName("lepidodendron:permian_ocean_sponge_reef");
	    ...
	    public void decorate(World worldIn, Random rand, BlockPos pos)
	    {
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.ROCK))
				for (int i = 0; i < 36; ++i)
				{
					...
					if (
						...
						REEF_GENERATOR.generate(worldIn, rand, pos1, 3, BlockSpongeReef.block.getDefaultState());
					}
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 3; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					STATIC_ROTATIONAL_GENERATOR.generate(BlockBivalveShikamaia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 255, 0, 255);
				}
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 24; ++i) {
					for (int ii = 0; ii < 10; ++ii) {
						...
						STATIC_SIDEWAYS_GENERATOR.generate(BlockGigantospongia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 255, 0, 255);
					}
				}

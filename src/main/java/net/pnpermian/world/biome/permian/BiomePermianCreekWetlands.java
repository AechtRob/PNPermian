...
public class BiomePermianCreekWetlands extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_creek_wetlands")
	public static final BiomeGenCustom biome = null;
	public BiomePermianCreekWetlands(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Wetland Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.95F).setRainfall(0.9F).setWaterColor(3906905));
			setRegistryName("lepidodendron:permian_creek_wetlands");

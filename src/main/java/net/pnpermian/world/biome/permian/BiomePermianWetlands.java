...
public class BiomePermianWetlands extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Wooded Wetlands").setRainfall(0.5F).setBaseHeight(-0.05F).setHeightVariation(0.02F).setTemperature(0.95F).setRainfall(0.9F).setWaterColor(3906905));
			setRegistryName("lepidodendron:permian_wetlands");

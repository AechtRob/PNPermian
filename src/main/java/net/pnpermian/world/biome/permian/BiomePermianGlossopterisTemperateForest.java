...
public class BiomePermianGlossopterisTemperateForest extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Temperate Glossopteris Forest").setRainfall(0.4F).setBaseHeight(0.04F).setHeightVariation(0.22F).setTemperature(0.7F).setWaterColor(-5317633));

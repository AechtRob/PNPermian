...
public class BiomePermianLowlandsForest extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Permian Wooded Scrub").setRainfall(0.01F).setBaseHeight(0.030F).setHeightVariation(0.175F).setTemperature(2.2F).setWaterColor(5948010));

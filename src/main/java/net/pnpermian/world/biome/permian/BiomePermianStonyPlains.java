...
public class BiomePermianStonyPlains extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_stony_plains")
	public static final BiomeGenCustom biome = null;
	public BiomePermianStonyPlains(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:permian_stony_plains");

...
public class BiomePermianGlossopterisTemperateWaterMeadow extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Temperate Water-Meadow").setRainfall(0.4F).setBaseHeight(-0.02F).setHeightVariation(0.01F).setTemperature(0.7F).setWaterColor(-5317633));

...
public class BiomePermianCreekDesert extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_creek_desert")
	public static final BiomeGenCustom biome = null;
	public BiomePermianCreekDesert(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Permian Desert Creek").setRainfall(0.0F).setBaseHeight(-0.425F).setHeightVariation(0.0F).setTemperature(2.2F).setRainDisabled().setWaterColor(16767282));
			setRegistryName("lepidodendron:permian_creek_desert");

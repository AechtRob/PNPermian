...
public class BiomePermianCreekLowlandFloodplainBrake extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_creek_lowlands_floodplain_brake")
	public static final BiomeGenCustom biome = null;
	public BiomePermianCreekLowlandFloodplainBrake(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Coastal Brake").setBaseHeight(-0.565F).setHeightVariation(0.0F).setTemperature(0.8F).setRainfall(0.4F));
			setRegistryName("lepidodendron:permian_creek_lowlands_floodplain_brake");
		...
		protected static final WorldGenSigillariaTiny SIGILLARIA_GENERATOR = new WorldGenSigillariaTiny();

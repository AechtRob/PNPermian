...
public class BiomeProviderPermian extends BiomeProvider {
    public static List<Biome> allowedBiomes = Lists.newArrayList(
            ...
            Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:permian_creek_arid_lands_lush")),
            ...
            Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:permian_creek_wetlands_fern_copse")),

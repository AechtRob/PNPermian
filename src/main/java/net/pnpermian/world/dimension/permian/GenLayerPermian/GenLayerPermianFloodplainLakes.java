...
public class GenLayerPermianFloodplainLakes extends GenLayer
{

    public Biome PERMIAN_FLOODPLAIN = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:permian_lowlands_floodplain"));
    public int PERMIAN_FLOODPLAIN_ID =  Biome.getIdForBiome(PERMIAN_FLOODPLAIN);

    public Biome PERMIAN_LAKES = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:permian_lowlands_floodplain_lake"));
    public int PERMIAN_LAKES_ID =  Biome.getIdForBiome(PERMIAN_LAKES);

    public GenLayerPermianFloodplainLakes(long seed, GenLayer genLayer)
    {
        super(seed);

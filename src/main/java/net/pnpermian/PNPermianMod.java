...
@Mod(modid = PNPermianMod.MODID, name = PNPermianMod.NAME, version = PNPermianMod.VERSION, dependencies = "required-after:lepidodendron@[62.0,)")
public class PNPermianMod {
    ...
    @Mod.Instance(MODID)
    public static PNPermianMod instance;
    public ElementsPNPermianMod elements = new ElementsPNPermianMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsPNPermianMod.GuiHandler());
